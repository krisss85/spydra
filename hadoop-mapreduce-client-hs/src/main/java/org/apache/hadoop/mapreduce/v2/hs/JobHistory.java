...
public class JobHistory extends AbstractService implements HistoryContext {
  ...
  protected void serviceStart() throws Exception {
    ...
    scheduledExecutor.scheduleAtFixedRate(new ReinitializeJHS(),
  ...
  private class ReinitializeJHS implements Runnable {
    @Override
    public void run() {
      try {
        LOG.info("Starting initializing JHS");
        hsManager.initExisting();
      } catch (IOException e) {
        LOG.error("Error while re-intializing JHS ", e);
      }
    }
  }
